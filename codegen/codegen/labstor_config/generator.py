...
def create_config(path, var_name, config_path, macro_name):
    ...
    config_lines = []
    config_lines.append(f"#ifndef HERMES_RUN_SRC_CONFIG_{macro_name}_DEFAULT_H_")
    config_lines.append(f"#define HERMES_RUN_SRC_CONFIG_{macro_name}_DEFAULT_H_")
    config_lines += string_lines
    config_lines.append(f"#endif  // HERMES_RUN_SRC_CONFIG_{macro_name}_DEFAULT_H_")
