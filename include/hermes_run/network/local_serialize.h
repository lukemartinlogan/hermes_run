...
#ifndef HERMES_RUN_INCLUDE_HERMES_RUN_NETWORK_LOCAL_SERIALIZE_H_
#define HERMES_RUN_INCLUDE_HERMES_RUN_NETWORK_LOCAL_SERIALIZE_H_
...
#endif  // HERMES_RUN_INCLUDE_HERMES_RUN_NETWORK_LOCAL_SERIALIZE_H_
