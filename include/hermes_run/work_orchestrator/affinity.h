...
#ifndef HERMES_RUN_INCLUDE_HERMES_RUN_WORK_ORCHESTRATOR_AFFINITY_H_
#define HERMES_RUN_INCLUDE_HERMES_RUN_WORK_ORCHESTRATOR_AFFINITY_H_
...
#endif  // HERMES_RUN_INCLUDE_HERMES_RUN_WORK_ORCHESTRATOR_AFFINITY_H_
