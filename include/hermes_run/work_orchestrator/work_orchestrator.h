...
#ifndef HERMES_RUN_INCLUDE_HERMES_RUN_WORK_ORCHESTRATOR_WORK_ORCHESTRATOR_H_
#define HERMES_RUN_INCLUDE_HERMES_RUN_WORK_ORCHESTRATOR_WORK_ORCHESTRATOR_H_
...
#define HERMES_RUN_WORK_ORCHESTRATOR \
  (&HERMES_RUN_RUNTIME->work_orchestrator_)

#endif  // HERMES_RUN_INCLUDE_HERMES_RUN_WORK_ORCHESTRATOR_WORK_ORCHESTRATOR_H_
