#ifndef HERMES_RUN_SRC_CONFIG_SERVER_DEFAULT_H_
#define HERMES_RUN_SRC_CONFIG_SERVER_DEFAULT_H_
const char* kHermesRunServerDefaultConfigStr =
...
"  \'ram_bdev\'\n"
"]\n";
#endif  // HERMES_RUN_SRC_CONFIG_SERVER_DEFAULT_H_