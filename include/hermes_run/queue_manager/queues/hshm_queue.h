...
#ifndef HERMES_RUN_INCLUDE_HERMES_RUN_QUEUE_MANAGER_HSHM_QUEUE_H_
#define HERMES_RUN_INCLUDE_HERMES_RUN_QUEUE_MANAGER_HSHM_QUEUE_H_

#include "hermes_run/queue_manager/queue.h"
...
#endif  // HERMES_RUN_INCLUDE_HERMES_RUN_QUEUE_MANAGER_HSHM_QUEUE_H_
