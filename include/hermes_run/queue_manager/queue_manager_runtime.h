...
#ifndef HERMES_RUN_INCLUDE_HERMES_RUN_QUEUE_MANAGER_QUEUE_MANAGER_SERVER_H_
#define HERMES_RUN_INCLUDE_HERMES_RUN_QUEUE_MANAGER_QUEUE_MANAGER_SERVER_H_
...
#define HERMES_RUN_QM_RUNTIME \
  (&HERMES_RUN_RUNTIME->queue_manager_)
...
#endif  // HERMES_RUN_INCLUDE_HERMES_RUN_QUEUE_MANAGER_QUEUE_MANAGER_SERVER_H_
