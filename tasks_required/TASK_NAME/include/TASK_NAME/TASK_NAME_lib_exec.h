#ifndef HERMES_RUN_TASK_NAME_LIB_EXEC_H_
#define HERMES_RUN_TASK_NAME_LIB_EXEC_H_
...
void Del(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kCustom: {
      HERMES_RUN_CLIENT->DelTask(reinterpret_cast<CustomTask *>(task));
      break;
    }
  }
}
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kCustom: {
      task_ptr.ptr_ = HERMES_RUN_CLIENT->NewEmptyTask<CustomTask>(task_ptr.shm_);
