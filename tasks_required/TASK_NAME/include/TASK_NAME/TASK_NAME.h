...
#ifndef HERMES_RUN_TASK_NAME_H_
#define HERMES_RUN_TASK_NAME_H_
...
class Client : public TaskLibClient {
 ...
 public:
  ...
  void AsyncCustomConstruct(CustomTask *task,
                            ...
                            const DomainId &domain_id) {
    HERMES_RUN_CLIENT->ConstructTask<CustomTask>(
  ...
  HERMES_RUN_TASK_NODE_PUSH_ROOT(Custom);
};

}  // namespace hrun

#endif  // HERMES_RUN_TASK_NAME_H_
