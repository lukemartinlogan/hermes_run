#ifndef HERMES_RUN_PROC_QUEUE_LIB_EXEC_H_
#define HERMES_RUN_PROC_QUEUE_LIB_EXEC_H_
...
void Del(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kPush: {
      HERMES_RUN_CLIENT->DelTask(reinterpret_cast<PushTask *>(task));
      break;
    }
  }
}
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kPush: {
      task_ptr.ptr_ = HERMES_RUN_CLIENT->NewEmptyTask<PushTask>(task_ptr.shm_);
...
#endif  // HERMES_RUN_PROC_QUEUE_METHODS_H_