#ifndef HERMES_RUN_WORCH_PROC_ROUND_ROBIN_LIB_EXEC_H_
#define HERMES_RUN_WORCH_PROC_ROUND_ROBIN_LIB_EXEC_H_
...
void Del(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kSchedule: {
      HERMES_RUN_CLIENT->DelTask(reinterpret_cast<ScheduleTask *>(task));
      break;
    }
  }
}
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kSchedule: {
      task_ptr.ptr_ = HERMES_RUN_CLIENT->NewEmptyTask<ScheduleTask>(task_ptr.shm_);
...
#endif  // HERMES_RUN_WORCH_PROC_ROUND_ROBIN_METHODS_H_