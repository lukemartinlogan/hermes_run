...
#ifndef HERMES_RUN_TASKS_HERMES_RUN_ADMIN_INCLUDE_HERMES_RUN_ADMIN_HERMES_RUN_ADMIN_TASKS_H_
#define HERMES_RUN_TASKS_HERMES_RUN_ADMIN_INCLUDE_HERMES_RUN_ADMIN_HERMES_RUN_ADMIN_TASKS_H_
...
#include "hermes_run_admin_methods.h"
...
struct RegisterTaskLibTaskTempl : public Task, TaskFlags<TF_SRL_SYM> {
  ...
  RegisterTaskLibTaskTempl(hipc::Allocator *alloc,
    ...
    task_state_ = HERMES_RUN_QM_CLIENT->admin_task_state_;
...
#endif  // HERMES_RUN_TASKS_HERMES_RUN_ADMIN_INCLUDE_HERMES_RUN_ADMIN_HERMES_RUN_ADMIN_TASKS_H_
